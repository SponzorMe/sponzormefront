describe("Activation Controller Tests", function(){
  ...
  it("Should be invalid token", function(){
    httpBackend.when('GET', 'https://apistaging.sponzor.me/verify_activation/miBadToken123').respond(404, {
  ...
  it("Should be a valid token", function(){
    httpBackend.when('GET', 'https://apistaging.sponzor.me/verify_activation/myTrueToken').respond(200,{
