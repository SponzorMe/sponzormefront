describe("Organizers Event Edit Controller test", function(){
  ...
  it("Should be vars Initialization", function(){
    httpBackend.when('GET', 'https://apistaging.sponzor.me/events/'+1).respond(400, {
    "data": {
      "event": {
        "id": "3",
        "title": "Dancing",
  ...
  it("Should be ok displaying the edit form", function(){
    httpBackend.when('GET', 'https://apistaging.sponzor.me/events/'+1).respond(200, {
    "data": {
      "event": {
        "id": "1",
        "title": "Dancing",
  ...
  it("Should be ok editing an event", function(){
    httpBackend.when('PATCH', 'https://apistaging.sponzor.me/perks').respond(200, {
      "message": "Updated",
      "perk": {
        "title": "Test",
        "body": "test",
    ...
    httpBackend.when('PATCH', 'https://apistaging.sponzor.me/events/'+1).respond(200, {
      "message": "Updated",
      "warnings": [],
      "event": {
        "id": "15",
  ...
  it("Should be not event info found", function(){
    ...
    httpBackend.when('PATCH', 'https://apistaging.sponzor.me/events/'+1).respond(400, {
      "message": "Updated",
      "warnings": [],
      "event": {
        "id": "15",
