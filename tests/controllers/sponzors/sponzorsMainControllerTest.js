describe("Organizers Create Controller test", function(){
      ...
      "events": [
        {
          ...
          "starts": new Date("2015-12-29T04:00:00"),
        ...
        },
        {
          ...
          "starts": new Date("2016-01-01T00:00:00"),
  ...
  it("Should be Show organizer Info Success", function(){
    ...
    httpBackend.flush();
    expect(scope.user.rating).toBe(5);
  });

  it("Should be Show organizer Info Fail 1", function(){
    httpBackend.when('GET', apiUrl+'events').respond(200, {
      "success": true,
      "events": [
        {
    ...
    httpBackend.when('GET', apiUrl + 'users/' + 1003).respond(400, {
      "data": {
        "user": {
          "id": "3",
          "title": "Dancing",
