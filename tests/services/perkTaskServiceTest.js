describe("PerkTask Service Unit Tests", function() {
  ...
  describe('All Perk tasks', function() {
    ...
    beforeEach(inject(function($injector) {
      ...
      $httpBackend.when('GET', 'http://apistaging.sponzor.me/perk_tasks').respond(200, {
        "success": true
      });
    }));
  ...
  describe('One PerkTask', function() {
    ...
    beforeEach(inject(function($injector) {
      // Set up the mock http service responses
      $httpBackend = $injector.get('$httpBackend');
      $httpBackend.when('GET', 'http://apistaging.sponzor.me/perk_tasks/'+perkTaskId).respond(200, {
      "data": {
        "perkTask": {
          "id": "3",
          "title": "Dancing",
  ...
  describe('create PerkTask', function() {
    ...
    beforeEach(inject(function($injector) {
      // Set up the mock http service responses
      $httpBackend = $injector.get('$httpBackend');
      $httpBackend.when('POST', 'http://apistaging.sponzor.me/perk_tasks').respond(200, {
        "message": "Inserted",
        "perkTask": {
          "title": "Test",
          "body": "test",
  ...
  describe('Delete PerkTask', function() {
    ...
    beforeEach(inject(function($injector) {
      // Set up the mock http service responses
      $httpBackend = $injector.get('$httpBackend');
      $httpBackend.when('DELETE', 'http://apistaging.sponzor.me/perk_tasks/'+perkTaskId).respond(200, {
        "message": "Deleted"
      })
    }));
    afterEach(function() {
  ...
  describe('Edit PerkTask PATCH', function() {
    ...
    beforeEach(inject(function($injector) {
      // Set up the mock http service responses
      $httpBackend = $injector.get('$httpBackend');
      $httpBackend.when('PATCH', 'http://apistaging.sponzor.me/perk_tasks/'+perkTaskId).respond(200, {
        "message": "Updated",
        "warnings": [],
        "perkTask": {
          "id": "15",
  ...
  describe('Edit PerkTask PUT', function() {
    ...
    beforeEach(inject(function($injector) {
      // Set up the mock http service responses
      $httpBackend = $injector.get('$httpBackend');
      $httpBackend.when('PUT', 'http://apistaging.sponzor.me/perk_tasks/'+perkTaskId).respond(200, {
        "message": "Updated",
        "warnings": [],
        "perkTask": {
          "id": "15",
