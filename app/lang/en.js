var translationsEN = {
      ...
      asSponzor: "As Sponzor",
      asOrganizer: "As Organizer",
      //Here starts the Categories
      Outdoor:'Outdoor',
      ArtANDCulture:'Art & Culture',
      Dancing:'Dancing',
      Wellness:'Wellness',
      CareerANDBusiness:'Career & Business',
      EatANDFoods:'Eat & Foods',
      Belief:'Belief',
      ...
      Painting:'Painting',
      CreativeCircle:'Creative Circle',
      ArtsANDEntertainment:'Arts & Entertainment',
      GraphicDesign:'Graphic Design',
      Drawing:'Drawing',
      BallroomDancing:'Ballroom Dancing',
      DanceLessons:'Dance Lessons',
      BellyDanceLessons:'Belly Dance Lessons',
      Dancing:'Dancing',
      SocialDancing:'Social Dancing',
      Salsa:'Salsa',
      LatinDance:'Latin Dance',
      DanceandMovement:'Dance and Movement',
      SwingDancing:'Swing Dancing',
      SalsaDanceLessons:'Salsa Dance Lessons',
      Bachata:'Bachata',
      Tango:'Tango',
      PTSD:'PTSD',
      ...
      CancerSurvivors:'Cancer Survivors',
      MedicalMarijuana:'Medical Marijuana',
      HealthyFamily:'Healthy Family',
      SpecialNeedsFamilies:'Special Needs Families',
      GriefSupport:'Grief Support',
      ADHD:'ADHD',
      RelationshipBuilding:'Relationship Building',
      RealEstate:'Real Estate',
      AsianProfessionals:'Asian Professionals',
      BusinessStrategy:'Business Strategy',
      LeadershipDevelopment:'Leadership Development',
      IndianProfessionals:'Indian Professionals',
      ProfessionalDevelopment:'Professional Development',
      Leadership:'Leadership',
      GolfasaBusinessTool:'Golf as a Business Tool',
      Fundraising:'Fundraising',
      YoungProfessionals:'Young Professionals',
      Success:'Success',
      LatinoaProfessionals:'Latino/a Professionals',
      DiningOut:'Dining Out',
      PubsandBars:'Pubs and Bars',
      Wine:'Wine',
      Vegan:'Vegan',
      Beer:'Beer',
      ExploringNewRestaurants:'Exploring New Restaurants',
      LivingFoods:'Living Foods',
      BBQ:'BBQ',
      ...
      NLP:'NLP',
      CatholicSocial:'Catholic Social',
      Freethinker:'Freethinker',
      Retreats:'Retreats',
      ACourseInMiracles:'A Course In Miracles',
      Transformation:'Transformation',
      ProgressiveMuslim:'Progressive Muslim',
      Sensuality:'Sensuality',
      Fitness:'Fitness',
      Exercise:'Exercise',
      Walking:'Walking',
      NFLFootball:'NFL Football',
      Golf:'Golf',
      PickupTennis:'Pick-up Tennis',
      Volleyball:'Volleyball',
      WaterSports:'Water Sports',
      Cycling:'Cycling',
      RollerSkating:'Roller Skating',
      RecreationalSports:'Recreational Sports',
      OutdoorFitness:'Outdoor Fitness',
      Science:'Science',
      EducationANDTechnology:'Education & Technology',
      IntellectualDiscussion:'Intellectual Discussion',
      Learning:'Learning',
      InternationalRelations:'International Relations',
      SexualEducation:'Sexual Education',
      CollegeAlumni:'College Alumni',
      HomeschoolSupport:'Homeschool Support',
      Evolution:'Evolution',
      ...
      FilmandVideoProduction:'Film and Video Production',
      DigitalPhotography:'Digital Photography',
      Film:'Film',
      PhotographyClasses:'Photography Classes',
      MovieNights:'Movie Nights',
      PortraitPhotography:'Portrait Photography',
      GroupPhotoShoots:'Group Photo Shoots',
      ModelPhotography:'Model Photography',
      ...
      IndianCulture:'Indian Culture',
      CulturalDiversity:'Cultural Diversity',
      BlackIdentity:'Black Identity',
      LatinoCulture:'Latino Culture',
      ...
      NovelReading:'Novel Reading',
      Screenwriting:'Screenwriting',
      NovelWriting:'Novel Writing',
      LiveMusic:'Live Music',
      Musicians:'Musicians',
      Singing:'Singing',
      ShamanicDrumming:'Shamanic Drumming',
